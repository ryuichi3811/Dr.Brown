...
const SelfCheck: NextPage = () => {
    ...
    <Layout siteName={siteName} desc={desc}>
      ...
      <FormControl>
        ...
        >
          ...
          <FormControlLabel value='3' control={<Radio />} label='持続する' />
          <FormControlLabel value='4' control={<Radio />} label='時々' />
          <FormControlLabel value='5' control={<Radio />} label='狭い範囲' />
          <FormControlLabel value='6' control={<Radio />} label='広い範囲' />
        </RadioGroup>
      </FormControl>
      <br />
      <FormControl>
      ...
      <FormControl>
        ...
        <RadioGroup
          ...
          name='radio-buttons-group'
        >
          <FormControlLabel value='1' control={<Radio />} label='動く時' />
          <FormControlLabel
            value='2'
            control={<Radio />}
            label='咳をしたとき'
          />
          <FormControlLabel value='3' control={<Radio />} label='空腹時' />
          <FormControlLabel value='4' control={<Radio />} label='食事後' />
          <FormControlLabel value='5' control={<Radio />} label='飲酒後' />
      ...
      <FormControl>
        ...
        <RadioGroup
          ...
          name='radio-buttons-group'
        >
          <FormControlLabel value='1' control={<Radio />} label='座った時' />
          <FormControlLabel
            value='2'
            control={<Radio />}
            label='前屈みになった時'
          />
          <FormControlLabel value='3' control={<Radio />} label='嘔吐後' />
          <FormControlLabel value='4' control={<Radio />} label='排便後' />
          <FormControlLabel value='other' control={<Radio />} label='その他' />
        </RadioGroup>
      </FormControl>
      <br />
      <FormControl>
        <FormLabel id='mitigated'>6.痛い場所は図のどの辺りですか？</FormLabel>
      ...
      <FormControl>
        ...
        <RadioGroup
          ...
          name='radio-buttons-group'
        >
          <FormControlLabel value='1' control={<Radio />} label='よく飲む' />
          <FormControlLabel value='2' control={<Radio />} label='時々飲む' />
          <FormControlLabel value='3' control={<Radio />} label='飲まない' />
        </RadioGroup>
      </FormControl>
      <br />
      <FormControl>
  ...
  >
    ...
    <FormControlLabel value='2' control={<Radio />} label='いいえ' />
